...
function SpotifyWebHelper(opts) {
	...
	// Keep track of playing_position ourselves between requests to Spotify's service,
	// updating it every SEEK_INTERVAL_LENGTH ms.
	...
	// Used when user shuts down the Spotify client.
	var waitForShutdown = () => {
		return new Promise((resolve, reject) => {
